          ...
          {type === "city" && (
            <div className="relative">
              ...
              <select value={stateId} onChange={e => setStateId(e.target.value)}
                className={`w-full border rounded px-3 pt-4 pb-2 text-sm focus:outline-none bg-white appearance-none ${!stateId ? "border-gray-300" : "border-gray-300"} focus:border-blue-400`}
